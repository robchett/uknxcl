...
JS;
        ...
        return [
            modal::create('delete_modal', [
                ...
                node::create('button.close', ['data-dismiss' => 'modal'], '<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>') . node::create('div.modal-title', [], 'Delete'), 
                "<p>Are you sure you want to do this?<p>", 
                node::create('button.btn.btn-default', ['data-dismiss' => 'modal'], 'Cancel') . node::create('button#delete.btn.btn-primary', ['data-dismiss' => 'modal', 'data-ajax-click' => attribute_callable::create([controller::class, 'do_delete'])], 'Delete')
            ),
            modal::create('undelete_modal', [
                ...
                node::create('button.close', ['data-dismiss' => 'modal'], '<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>') . node::create('div.modal-title', [], 'Un Delete'), 
                "<p>Are you sure you want to do this?<p>",
                node::create('button.btn.btn-default', ['data-dismiss' => 'modal'], 'Cancel') . node::create('button#undelete.btn.btn-primary', ['data-dismiss' => 'modal', 'data-ajax-click' => attribute_callable::create([controller::class, 'do_undelete'])], 'Un-delete')
            ),
            modal::create('true_delete_modal', [
                ...
                node::create('button.close', ['data-dismiss' => 'modal'], '<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>') . node::create('div.modal-title', [], 'Completely Delete'), 
                node::create('h2', [], 'This cannot be reversed!') . "<p>Are you sure you want to do this?<p>",
                node::create('button.btn.btn-default', ['data-dismiss' => 'modal'], 'Cancel') . node::create('button#undelete.btn.btn-primary', ['data-dismiss' => 'modal', 'data-ajax-click' => attribute_callable::create([controller::class, 'do_delete'])], 'Delete')
            )
        ];
    }
