...
class igc_supported extends html {
...
var \$body = $("body");
    ...
    \$body.on("click","a.score_select",function () {
        ...
        $("#type").val(data.type);
        $("#igc_upload_form").html("<p class='restart'>Your flight details have been saved, please complete the form below, 'Additional Details', to finalise your sumbission.<br/><a data-ajax-click='$hash' href='#' class='button'>Restart</a></p>");
