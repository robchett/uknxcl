...
class league_table_options {
    ...
    public false|null|string $year = null;
    ...
    public int $handicap_kingpost = 1;
    public int $handicap_rigid = 1;
    ...
    public function remove_launch($id): bool {
    ...
    public function remove_flight_type($id): bool {
