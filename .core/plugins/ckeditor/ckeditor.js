...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        ...
        if (c) {
            var a = b.getUrl;
            b.getUrl = function (g) {return c.call(b, g) || a.call(b, g)}
        }
        return b
    }());
    CKEDITOR.event || (CKEDITOR.event = function () {}, CKEDITOR.event.implementOn = function (b) {
        ...
        return{define: function (a, e) {
            ...
            function l() {m.removeListener(a, e)}
            ...
            once: function () {
                ...
                var a = 0, b = function () {a = 1}, d = 0, f = function () {d = 1};
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (a.gecko)if (g < 10900)a.cssClass = a.cssClass + " cke_browser_gecko18"; else if (g <= 11E3)a.cssClass = a.cssClass + " cke_browser_gecko19";
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (a, b) {
            ...
            for (var c = 1; c < b; c++) {
                var i = arguments[c], j;
                for (j in i)if (e === true || a[j] == void 0)if (!d || j in d)a[j] = i[j]
            }
            return a
            ...
            for (e in a)b[e] = a[e];
            return b
        }, isArray: function (a) {return!!a && a instanceof Array}, isEmpty: function (a) {
            ...
            return e.join("")
        }, htmlEncode: function (a) {return("" + a).replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;")}, htmlEncodeAttr: function (a) {
            return a.replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
        }, getNextNumber: function () {
            var a = 0;
            return function () {return++a}
        }(), getNextId: function () {return"cke_" + this.getNextNumber()}, override: function (a, b) {
            var e = b(a);
            ...
            c || (c = window);
            e || (e = c);
            return c.setTimeout(function () {d ? a.apply(e, [].concat(d)) : a.apply(e)}, b || 0)
        }, trim: function () {
            var a = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g;
            ...
            if (typeof b == "function")for (var e = 0, d = a.length; e < d; e++) {if (b(a[e]))return e} else {
            ...
            var b = a.$, e = a.base, d = a.privates || a._, c = a.proto, a = a.statics;
            ...
            return b
        }, addFunction: function (a, g) {return b.push(function () {return a.apply(g || this, arguments)}) - 1}, removeFunction: function (a) {b[a] = null}, callFunction: function (a) {
            var g = b[a];
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function (b, c) {
    ...
    }, hasPrevious: function () {return!!this.$.previousSibling}, hasNext: function () {return!!this.$.nextSibling}, insertAfter: function (b) {
        ...
        return c
    }, getDocument: function () {return new CKEDITOR.dom.document(this.$.ownerDocument || this.$.parentNode.ownerDocument)}, getIndex: function (b) {
        var c = this.$, a = -1, g;
        ...
        for (; a;) {
            ...
            try {a = a.parentNode} catch (e) {a = null}
        }
        return null
        ...
        return false
    }, move: function (b, c) {b.append(this.remove(), c)}, remove: function (b) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (b) {
        ...
        return a
    }, createText: function (b) {return new CKEDITOR.dom.text(b, this)}, focus: function () {this.getWindow().focus()}, getActive: function () {return new CKEDITOR.dom.element(this.$.activeElement)}, getById: function (b) {return(b = this.$.getElementById(b)) ? new CKEDITOR.dom.element(b) : null}, getByAddress: function (b, c) {
    ...
    }, getBody: function () {return new CKEDITOR.dom.element(this.$.body)}, getDocumentElement: function () {return new CKEDITOR.dom.element(this.$.documentElement)}, getWindow: function () {
    ...
    CKEDITOR.dom.nodeList.prototype = {count: function () {return this.$.length}, getItem: function (b) {
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            getTabIndex: CKEDITOR.env.ie ? function () {
                ...
                return a
            } : function () {return this.$.tabIndex}, getText: function () {return this.$.textContent || this.$.innerText || ""}, getWindow: function () {return this.getDocument().getWindow()}, getId: function () {
                return this.$.id || null
            }, getNameAtt: function () {return this.$.name || null}, getName: function () {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var j = this.$.getBoundingClientRect(), l = d.$.documentElement, n = l.clientTop || f.$.clientTop || 0, m = l.clientLeft || f.$.clientLeft || 0, o = true;
                    if (CKEDITOR.env.ie) {
                ...
                function m(a, b) {return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0}
            ...
            copyAttributes: function (a, b) {
                ...
                this.on("contextmenu", function (a) {a.data.getTarget().hasClass("cke_enable_context_menu") || a.data.preventDefault()})
    ...
    (function () {
        function b(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function (a, b) {return(!b || !F.equals(a)) && (!z || !a.equals(z)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))}
            }
            var q = a ? this._.guardRTL : this._.guardLTR;
            k = h ? function (a, b) {return q(a, b) === false ? false : h(a, b)} : q;
            if (this.current)d = this.current[g](false, s, k); else {
                if (a)d.type == CKEDITOR.NODE_ELEMENT && (d = o > 0 ? d.getChild(o - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, s, k)); else {
                    d = n;
    ...
    (function () {
        ...
        function a(a) {return!i(a) && !j(a)}

        var g = function (a) {a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset}, e = function (a, b, c, k) {
            a.optimizeBookmark();
        ...
        CKEDITOR.dom.range.prototype = {clone: function () {
            ...
            if (b.type == CKEDITOR.NODE_ELEMENT) {
                h = b.getChildCount();
                if (h > d)b = b.getChild(d).getPreviousSourceNode(true); else if (h < 1)b = b.getPreviousSourceNode(); else {
            ...
            var c = this.startContainer, d = this.startOffset, h = this.collapsed;
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        f.evaluator = function (a) {return!G(a) && !E(a)};
            ...
            if (!this.collapsed) {
                ...
                if (i)(h = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(h, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                if (j) {
                    d.reset();
            ...
            moveToPosition: function (a, b) {
                ...
                g(this)
            }, setStartAfter: function (a) {this.setStart(a.getParent(), a.getIndex() + 1)}, setStartBefore: function (a) {this.setStart(a.getParent(), a.getIndex())}, setEndAfter: function (a) {this.setEnd(a.getParent(), a.getIndex() + 1)}, setEndBefore: function (a) {
                ...
                var b = new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, h = c.block, f = null;
            ...
            moveToElementEditEnd: function (a) {return this.moveToElementEditablePosition(a, true)}, getEnclosedNode: function () {
                var a = this.clone();
                a.optimize();
    ...
    (function () {
        ...
        var a = /^[\r\n\t ]+$/, g = CKEDITOR.dom.walker.bookmark(false, true), e = CKEDITOR.dom.walker.whitespaces(true), d = function (a) {return g(a) && e(a)};
        b.prototype = {getNextParagraph: function (b) {
            ...
            if (!this._.nextNode)this._.nextNode = l || e.equals(n) || !n ? null : c(e, 1, n);
            return e
        }};
    ...
    CKEDITOR.command.prototype = {enable: function () {this.state == CKEDITOR.TRISTATE_DISABLED && this.checkAllowed() && this.setState(!this.preserveState || typeof this.previousState == "undefined" ? CKEDITOR.TRISTATE_OFF : this.previousState)}, disable: function () {this.setState(CKEDITOR.TRISTATE_DISABLED)}, setState: function (b) {
    ...
    (function () {
        ...
        function g(a) {
            ...
            return a._.filterFunction = function (h, f, m, e, g, o, k) {
                ...
                if (f) {
                    ...
                    if (f.allStyles) {if (p)u.style = p} else {
        ...
        function m(a) {return!a ? false : a === true ? true : function (b) {return b in a}}

        function o() {return new CKEDITOR.htmlParser.element("br")}

        function k(a) {return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || z.$block[a.name])}
            ...
            if (z.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(o()); else {
                ...
                b:{
                    ...
                    for (var f = 0, m = d.length, e; f < m; ++f) {
                        e = d[f];
                        if (e.type == CKEDITOR.NODE_ELEMENT && !h[e.name]) {
                            h = false;
                            break b
                        }
                    }
                ...
                if (h) {
                    ...
                    for (var f = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.name == "body", g, m = d.length; m > 0;) {
                        ...
                        if (f && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && z.$inline[e.name])) {
                            ...
                            g = null;
                            e.insertAfter(a);
                            h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (e.type == CKEDITOR.NODE_ELEMENT && !z[h.name][e.name]) && c.push({check: "el-up", el: e})
                        }
                    }
                    a.remove()
                }
        ...
        function w(a, b) {
            ...
            for (f in d)if (f == "class") {
                c = d[f].split(/\s+/);
                for (e = a.classes.join("|"); g = c.pop();)if (e.indexOf(g) == -1)return false
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            for (g in b) {
                e = b[g];
                e = typeof e == "boolean" ? {} : typeof e == "function" ? {match: e} : q(e);
            ...
            for (; i = a.pop();) {
                ...
                if (s.parent)switch (i.check) {
                    case "it":
                        ...
                        break;
                    case "el-up":
                        s.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !z[s.parent.name][s.name] && h(s, c, a);
                        break;
                    case "parent-down":
            ...
            addTransformations: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (m = 0; m < b.length; ++m) {
                            ...
                            c.push({check: g == f ? null : g, left: o, right: typeof k == "string" ? F(k) : k})
                        }
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if (typeof a == "string") {
                    ...
                    h.children = [];
                    o.length && (h.attributes["class"] = o.join(" "));
    ...
    (function () {
        ...
        CKEDITOR.focusManager.prototype = {focus: function () {
            ...
            this._.locked = 1
        }, unlock: function () {delete this._.locked}, blur: function (b) {
            function c() {
                if (this.hasFocus) {
                    this.hasFocus = false;
            ...
            if (!a || a != this) {
                ...
                var e = {blur: function () {b.equals(this.currentActive) && this.blur()}, focus: function () {
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return{load: function (a, g, e, d) {
            ...
            f && (a = [a]);
            e || (e = CKEDITOR);
            var i = a.length, j = [], l = [], n = function (a) {g && (f ? g.call(e, a) : g.call(e, j, l))};
            if (i === 0)n(true); else {
                var m = function (a, b) {
                    (b ? j : l).push(a);
                    if (--i <= 0) {
                    ...
                    if (b[a])m(a, true); else {
                        ...
                        if (!(d.length > 1)) {
                            ...
                            if (g)if (CKEDITOR.env.ie)h.$.onreadystatechange = function () {
                                ...
                                h.$.onload = function () {setTimeout(function () {o(a, true)}, 0)};
                                h.$.onerror = function () {o(a, false)}
                            }
    ...
    CKEDITOR.resourceManager.prototype = {add: function (b, c) {
        ...
        return this.get(b)
    }, get: function (b) {return this.registered[b] || null}, getPath: function (b) {
    ...
    }, addExternal: function (b, c, a) {for (var b = b.split(","), g = 0; g < b.length; g++)this.externals[b[g]] = {dir: c, file: a}}, load: function (b, c, a) {
    ...
    }, get: function (b) {return this.instances[b]}, create: function (b) {
    ...
    (function () {
        function b(b, d, m) {
            ...
            if (d !== void 0) {
                if (d instanceof CKEDITOR.dom.element) {if (!m)throw Error("One of the element mode must be specified.");} else throw Error("Expect element of type CKEDITOR.dom.element.");
                ...
                if (m == CKEDITOR.ELEMENT_MODE_INLINE && !d.is(CKEDITOR.dtd.$editable) || m == CKEDITOR.ELEMENT_MODE_REPLACE && d.is(CKEDITOR.dtd.$nonBodyContent))throw Error('The specified element mode is not supported on element: "' + d.getName() + '".');
                this.element = d;
                this.elementMode = m;
        ...
        function a() {
            var a = this.commands;
            if (this.mode)for (var b in a)g(this, a[b])
        }

        function g(a, b) {b[b.startDisabled ? "disable" : a.readOnly && !b.readOnly ? "disable" : b.modes[a.mode] ? "enable" : "disable"]()}
        ...
        function i(a) {CKEDITOR.skin.loadPart("editor", function () {j(a)})}
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.prototype = {onTagOpen: function () {}, onTagClose: function () {}, onText: function () {}, onCDATA: function () {}, onComment: function () {}, parse: function (a) {
    ...
    CKEDITOR.htmlParser.basicWriter = CKEDITOR.tools.createClass({$: function () {this._ = {output: []}}, proto: {openTag: function (b) {this._.output.push("<", b)}, openTagClose: function (b, c) {c ? this._.output.push(" />") : this._.output.push(">")}, attribute: function (b, c) {
        typeof c == "string" && (c = CKEDITOR.tools.htmlEncodeAttr(c));
        this._.output.push(" ", b, '="', c, '"')
    }, closeTag: function (b) {this._.output.push("</", b, ">")}, text: function (b) {this._.output.push(b)}, comment: function (b) {this._.output.push("<\!--", b, "--\>")}, write: function (b) {this._.output.push(b)},
        reset: function () {
            this._.output = [];
            this._.indent = false
        }, getHtml: function (b) {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {remove: function () {
            ...
            var c = b.parent.children, a = CKEDITOR.tools.indexOf(c, b), g = b.next;
            c.splice(a + 1, 0, this);
            this.next = b.next;
            this.previous = b;
            b.next = this;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, f) {
            function i(a) {
                ...
                if (s.length > 0)for (var c = 0; c < s.length; c++) {
                    var d = s[c], e = d.name, f = CKEDITOR.dtd[e], m = v.name && CKEDITOR.dtd[v.name];
            ...
            function j() {for (; w.length;)n(w.shift(), v)}
            ...
            k.onCDATA = function (a) {v.add(new CKEDITOR.htmlParser.cdata(a))};
    ...
    (function () {
        ...
        function e(a) {
            for (var b = a.type || a instanceof CKEDITOR.htmlParser.fragment, c = 0; c < this.length; c++) {
                ...
                if (n === false)return n;
                if (b) {if (n && (n.name != g || n.type != e))return n} else if (typeof n != "string")return n;
                n != void 0 && (a = n)
            }
            return a
        }
        ...
        }, applyTo: function (a) {a.filter(this)}, onElementName: function (a) {return b(a, this._.elementNames)}, onAttributeName: function (a) {return b(a, this._.attributeNames)}, onText: function (a) {
            var b = this._.text;
    ...
    (function () {
        function b(b, c) {
            function m(a) {return a || CKEDITOR.env.ie ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", {"data-cke-bogus": 1})}
        ...
        function d(a) {return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in A || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)}
        ...
        function o(a) {return a.replace(u, function (a, b, c) {return"<" + b + c.replace(x, function (a, b) {return!/^on/.test(b) && c.indexOf("data-cke-saved-" + b) == -1 ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a}) + ">"})}

        function k(a) {return a.replace(I, function (a) {return"<cke:encoded>" + encodeURIComponent(a) + "</cke:encoded>"})}

        function h(a) {return a.replace(G, function (a, b) {return decodeURIComponent(b)})}
        ...
        function t(a, b) {
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {id: 1}), m = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function (a) {return"<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>"}), h = 0; h < d.length; h++)a = a.replace(d[h], function (a) {
                a = a.replace(m, function (a, b, d) {return c[d]});
                return/cke_temp(comment)?/.test(a) ? a : "<\!--{cke_temp}" + (c.push(a) - 1) + "--\>"
            });
            a = a.replace(m, function (a, b, d) {return"<\!--" + z + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\>"});
        ...
        CKEDITOR.htmlDataProcessor = function (a) {
            ...
            a.on("toHtml", function (b) {
                var b = b.data, d = b.dataValue, d = t(d, a), d = o(d), d = k(d), d = d.replace(E, "$1cke:$2"), d = d.replace(L, "<cke:$1$2></cke:$1>"), d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = b.context || a.editable().getName(), m;
            ...
            a.on("toHtml", function (a) {a.data.dataValue.filterChildren(m.dataFilter, true)}, null, null, 10);
            ...
            a.on("toDataFormat", function (b) {b.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(b.data.dataValue, a.editable().getName(), c(a.config))}, null, null, 5);
            a.on("toDataFormat", function (a) {a.data.dataValue.filterChildren(m.htmlFilter, true)}, null, null, 10);
        ...
        var F = /(?:&nbsp;|\xa0)$/, z = "{cke_protected}", q = CKEDITOR.dtd, p = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], A = CKEDITOR.tools.extend({}, q.$blockLimit, q.$block), r = {elements: {}, attributeNames: [
            [/^on/, "data-cke-pa-on"]
        ]}, C = {elementNames: [
            [/^cke:/, ""],
            [/^\?xml:namespace$/, ""]
        ...
        var u = /<(a|area|img|input|source)\b([^>]*)>/gi, x = /\b(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, G = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, E = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, Q = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, L = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT, add: c.add, clone: function () {return new CKEDITOR.htmlParser.element(this.name, this.attributes)}, filter: function (a) {
            var b = this, c, d;
            ...
            c && this.filter(c);
            var e = this.name, d = [], f = this.attributes, i, j;
            a.openTag(e, f);
    ...
    (function () {
        ...
        CKEDITOR.replaceAll = function () {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                var c = null, e = a[b];
                if (e.name || e.id) {
                    if (typeof arguments[0] == "string") {if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)").test(e.className))continue} else if (typeof arguments[0] == "function") {
                        c = {};
    ...
    (function () {
        ...
        function e(b) {
            ...
            if (e.contains(g)) {
                ...
                e = function (b, d) {
                    return function (b, e) {
                        e && (b.type == CKEDITOR.NODE_ELEMENT && b.is(g)) && (c = b);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element,
            $: function (a, b) {
                ...
                if (!b) {
                    var g = /\n{2}/g;
                    if (g.test(a))var f = "<" + c + ">", i = "</" + c + ">", a = f + a.replace(g, function () {return i + f}) + i
                }
                a = a.replace(/\n/g, "<br>");
                ...
                d(this);
                for (var c = this.editor, e = c.config.enterMode, h = c.getSelection(), g = h.getRanges(), i = b.getName(), j = CKEDITOR.dtd.$block[i], l, n, z, q = g.length - 1; q >= 0; q--) {
                    l = g[q];
                    if (!l.checkReadOnly()) {
                        l.deleteContents(1);
                        n = !q && b || b.clone(1);
                ...
                getData: function (a) {
                    ...
                    this.attachListener(a, "beforeGetData", function () {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(i, function (a, b) {return b}));
                        a.setData(b, null, 1)
                    }, this);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in{8: 1, 46: 1}) {
                                ...
                                if (h = e(h)) {
                                    ...
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (g.blockLimit && g.blockLimit.is("td") && (k = g.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) && (o = k[c ? "getPrevious" : "getNext"](j))) {
                                    a.fire("saveSnapshot");
                                    b["moveToElementEdit" + (c ? "End" : "Start")](o);
        ...
        var i = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, j = CKEDITOR.dom.walker.whitespaces(true), l = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var n = function () {
            ...
            function d(a, c) {
                var e = [], g = a.getChildren(), h = g.count(), f, o = 0, i = j[c], l = !a.is(j.$inline) || a.is("br");
                for (l && e.push(" "); o < h; o++) {
                    f = g.getItem(o);
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            g.on("contentDom", function () {
                ...
                f.attachListener(f, "mousedown", function () {j = 0});
                ...
                if (CKEDITOR.env.ie && !i) {
                    var A;
                    f.attachListener(f, "mousedown", function (a) {a.data.$.button == 2 && g.document.$.selection.type == "None" && (A = g.window.getScrollPosition())});
                    ...
                    if (a.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)m.on("mousedown", function (a) {
                            ...
                            if (a.getTarget().is("html") && a.$.y < m.$.clientHeight && a.$.x < m.$.clientWidth) {
                                ...
                                try {d.moveToPoint(a.$.x, a.$.y)} catch (g) {}
                                var f = d.duplicate();
                                m.on("mousemove", b);
                                e.on("mouseup", c);
                                m.on("mouseup", c)
                ...
                if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    var C;
                    f.attachListener(f, "mousedown", function () {C = 1});
            ...
            g.on("dataReady", function () {g.selectionChange(1)});
            CKEDITOR.env.ie9Compat && g.on("beforeDestroy", e, null, null, 9);
            CKEDITOR.env.webkit && g.on("setData", e);
            g.on("contentDomUnload", function () {g.unlockSelection()})
        });
        CKEDITOR.on("instanceReady", function (a) {
            ...
            if (CKEDITOR.env.webkit) {
                ...
                b.on("beforeSetMode", function () {d(c)}, null, null, -1);
                var g, f, a = function () {
        ...
        CKEDITOR.dom.selection.prototype = {getNative: function () {return this._.cache.nativeSel !== void 0 ? this._.cache.nativeSel : this._.cache.nativeSel = l ? this.document.$.selection : this.document.getWindow().$.getSelection()}, getType: l ? function () {
            var a = this._.cache;
            ...
            var a = l ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (; e > 0;)try {
                        ...
                        f = i
                    } catch (u) {return{container: d, offset: a(f)}}
            ...
            return function (b) {
                ...
                if (b)for (var d = c.ranges, e = 0; e < d.length; e++) {
                    ...
                    if (!g.collapsed) {
                        ...
                        f && f.type == CKEDITOR.NODE_TEXT && (j ? l.setEndAfter(f) : l.setEndBefore(f));
        ...
        }, reset: function () {this._.cache = {}}, selectElement: function (a) {
            ...
            if (a.length)if (this.isLocked) {
                ...
                if (l) {
                    ...
                    for (e = 0; e < a.length; e++) {
                        ...
                        t.setStart(b.startContainer.$, b.startOffset);
                        try {t.setEnd(b.endContainer.$, b.endOffset)} catch (p) {
            ...
            try {a && a[l ? "empty" : "removeAllRanges"]()} catch (b) {}
            this.reset()
        }}
    })();
    ...
    (function () {
                        ...
                        if (!r || i[r] && !t && (!p || h) && (k.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(k))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || g) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !k.getChildCount()) {
                                    for (var q = k, w; (f = !q.getNext(C)) && (w = q.getParent(), i[w.getName()]) && (w.getPosition(l) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(w));)q = w;
                                    n.setEndAfter(q)
                                }
                            } else f = true
                        } else f = true;
        ...
        function v(a, b) {for (var c in a)a[c] = a[c].replace(r, function (a, c) {return b[c]})}
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {type: CKEDITOR.NODE_TEXT, getLength: function () {return this.$.nodeValue.length}, getText: function () {return this.$.nodeValue}, setText: function (b) {this.$.nodeValue = b}, split: function (b) {
        ...
        return d
    }, substring: function (b, c) {return typeof c != "number" ? this.$.nodeValue.substr(b) : this.$.nodeValue.substring(b, c)}});
    (function () {
        function b(a, b, c) {
            ...
            return{getNextRange: function (f) {
                ...
                if (i && a.length > 1) {
                    ...
                    if (f)for (var l = 0; a[d + l + 1];) {
                        for (var n = i.document, f = 0, j = n.getById(c[l].endNode), n = n.getById(c[l + 1].startNode); ;) {
    ...
    (function () {
        ...
        var d = {};
        CKEDITOR.skin = {path: b, loadPart: function (c, d) {CKEDITOR.skin.name != CKEDITOR.skinName.split(",")[0] ? CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(b() + "skin.js"), function () {a(c, d)}) : a(c, d)}, getPath: function (a) {return CKEDITOR.getUrl(c(a))}, icons: {}, addIcon: function (a, b, c) {
            a = a.toLowerCase();
    ...
    CKEDITOR.plugins.add("dialogui", {onLoad: function () {
        ...
        }, isVisible: function () {return this.getElement().getFirst().isVisible()}, isEnabled: function () {return!this._.disabled},
            eventProcessors: CKEDITOR.tools.extend({}, CKEDITOR.ui.dialog.uiElement.prototype.eventProcessors, {onClick: function (b, a) {this.on("click", function () {a.apply(this, arguments)})}}, !0), accessKeyUp: function () {this.click()}, accessKeyDown: function () {this.focus()}, keyboardFocusable: !0}, !0);
        CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {getInputElement: function () {return CKEDITOR.document.getById(this._.inputId)}, focus: function () {
    ...
    (function () {
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            this.on("cancel", function (b) {C(function (c) {if (c.isChanged())return confirm(a.lang.common.confirmCancel) || (b.data.hide = !1), !0})}, this, null, 0);
        ...
        CKEDITOR.dialog.prototype = {destroy: function () {
            ...
            }, showPage: function (a) {if (a = this._.tabs[a] && this._.tabs[a][0])a.show(), this._.pageCount++, this.updateStyle()}, getElement: function () {return this._.element}, getName: function () {return this._.name}, getContentElement: function (a, b) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dialog, {add: function (a, b) {if (!this._.dialogDefinitions[a] || "function" == typeof b)this._.dialogDefinitions[a] = b}, exists: function (a) {return!!this._.dialogDefinitions[a]}, getCurrent: function () {return CKEDITOR.dialog._.currentTop},
        ...
        L.prototype = {getContents: function (a) {return z(this.contents, a)}, getButton: function (a) {return z(this.buttons, a)}, addContents: function (a, b) {return A(this.contents, a, b)}, addButton: function (a, b) {return A(this.buttons, a, b)}, removeContents: function (a) {
            B(this.contents, a)
        ...
        }, O = function (a, b, c, e, d) {(t[c] || (t[c] = [])).push({uiElement: a, dialog: b, key: c, keyup: d || a.accessKeyUp, keydown: e || a.accessKeyDown})}, X = function (a) {
            for (var b in t) {
    ...
    (function () {
        function v(a) {
            ...
            function e(d) {
                return{type: d, canUndo: "cut" == d, startDisabled: !0, exec: function () {
                    ...
                    var d;
                    var b = this.type;
                    if (CKEDITOR.env.ie)d = k(b); else try {d = a.document.$.execCommand(b, !1, null)} catch (c) {d = !1}
            ...
            function l() {
                if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
                    ...
                    if (d.getType() == CKEDITOR.SELECTION_ELEMENT && (b = d.getSelectedElement()))c = d.getRanges()[0], e = a.document.createText(""), e.insertBefore(b), c.setStartBefore(e), c.setEndAfter(b), d.selectRanges([c]), setTimeout(function () {b.getParent() && (e.remove(), d.selectElement(b))}, 0)
                }
            }

            function j(d, b) {
                var c = a.document, e = a.editable(), l = function (a) {a.cancel()}, j = CKEDITOR.env.gecko && 10902 >= CKEDITOR.env.version;
            ...
            function n(b) {
                ...
                if ("Paste" == b) {
                    CKEDITOR.env.ie && (m = 1);
                    try {c = a.document.$.queryCommandEnabled(b) || CKEDITOR.env.webkit} catch (e) {}
                    m = 0
        ...
        function w(a) {
            if (CKEDITOR.env.webkit) {if (!a.match(/^[^<]*$/g) && !a.match(/^(<div><br( ?\/)?><\/div>|<div>[^<]*<\/div>)*$/gi))return"html"} else if (CKEDITOR.env.ie) {
                if (!a.match(/^([^<]|<br( ?\/)?>)*$/gi) && !a.match(/^(<p>([^<]|<br( ?\/)?>)*<\/p>|(\r\n))*$/gi))return"html"
            } else if (CKEDITOR.env.gecko || CKEDITOR.env.opera) {if (!a.match(/^([^<]|<br( ?\/)?>)*$/gi))return"html"} else return"html";
            return"htmlifiedtext"
        }

        function x(a, b) {
            function e(a) {return CKEDITOR.tools.repeat("</p><p>", ~~(a / 2)) + (1 == a % 2 ? "<br>" : "")}

            b = b.replace(/\s+/g, " ").replace(/> +</g, "><").replace(/<br ?\/>/gi, "<br>");
            b = b.replace(/<\/?[A-Z]+>/g, function (a) {return a.toLowerCase()});
            if (b.match(/^[^<]$/))return b;
            CKEDITOR.env.webkit && -1 < b.indexOf("<div>") && (b = b.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), b.match(/<div>(<br>|)<\/div>/) && (b = "<p>" + b.replace(/(<div>(<br>|)<\/div>)+/g, function (a) {return e(a.split("</div><div>").length + 1)}) + "</p>"), b = b.replace(/<\/div><div>/g, "<br>"), b = b.replace(/<\/?div>/g, ""));
        ...
        function p(a, b) {
            a.enterMode == CKEDITOR.ENTER_BR ? b = b.replace(/(<\/p><p>)+/g,function (a) {return CKEDITOR.tools.repeat("<br>", 2 * (a.length / 7))}).replace(/<\/?p>/g, "") : a.enterMode == CKEDITOR.ENTER_DIV && (b = b.replace(/<(\/)?p>/g, "<$1div>"));
            return b
        }
        ...
        CKEDITOR.plugins.add("clipboard", {requires: "dialog", init: function (a) {
            ...
            a.on("paste", function (e) {
                ...
                "htmlifiedtext" == h ? f = x(a.config, f) : "text" == c && "html" == h && (f = z(a.config, f, b || (b = y(a))));
    ...
    (function () {
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({$: function (a, b, c, h) {
            ...
            showBlock: function (a, b, c, h, g) {
                ...
                this._.activeChild == a && a._.panel._.offsetParentId == c.getId() || (this.hideChild(), a.onHide = CKEDITOR.tools.bind(function () {CKEDITOR.tools.setTimeout(function () {this._.focused || this.hide()}, 0, this)}, this), this._.activeChild = a, this._.focused = !1, a.showBlock(b, c, h, g, e), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) && setTimeout(function () {a.element.getChild(0).$.style.cssText += ""}, 100))
    ...
    (function () {
        ...
        var c = c + (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus="return CKEDITOR.tools.callFunction({focusFn},event);"  onmousedown="return CKEDITOR.tools.callFunction({mousedownFn},event);" ' + (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : "onclick") + '="CKEDITOR.tools.callFunction({clickFn},this);return false;"><span class="cke_button_icon cke_button__{iconName}_icon" style="{style}"'), c = c + '>&nbsp;</span><span id="{id}_label" class="cke_button_label cke_button__{name}_label">{label}</span>{arrowHtml}</a>', m = CKEDITOR.addTemplate("buttonArrow", '<span class="cke_button_arrow">' + (CKEDITOR.env.hc ? "&#9660;" : "") + "</span>"), n = CKEDITOR.addTemplate("button", c);
        ...
        function m(a, d) {
            ...
            a.on("selectionChange", function (b) {
                for (var e = a.editable(), c = b.data.selection.getStartElement(), b = [], f = a._.elementsPath.list = [], d = a._.elementsPath.filters; c;) {
                    ...
                    j || (j = f.push(c) - 1, k = a.lang.elementspath.eleTitle.replace(/%1/, g), g = s.output({id: q + j, label: k, text: g, jsTitle: "javascript:void('" + g + "')", index: j, keyDownFn: r, clickFn: m}), b.unshift(g));
                    if (c.equals(e))break;
                    c = c.getParent()
                }
    ...
    (function () {
        ...
        var r = {ol: 1, ul: 1}, E = CKEDITOR.dom.walker.whitespaces(), F = CKEDITOR.dom.walker.bookmark(), q = function (c) {return!(E(c) || F(c))}, u = CKEDITOR.dom.walker.bogus();
    ...
    (function () {
        function p(d, i) {
            ...
            this.allowedContent = {"div h1 h2 h3 h4 h5 h6 ol p pre ul": {propertiesOnly: !0, styles: !a ? "margin-left,margin-right" : null, classes: a ? d.config.indentClasses : null}};
                    ...
                    if (j && b) {
                        ...
                        if (!(1 > j.length)) {
                            ...
                            if (h && h.length)for (b = 0; b < h.length; b++) {
                                for (g = n = h[b]; (g = g.getNext()) && g.is && g.getName()in m;)CKEDITOR.env.ie && !n.getFirst(function (b) {return t(b) && u(b)}) && n.append(l.document.createText(" ")), n.append(g);
                                n.insertAfter(i)
                            }
                        }
                    }
        ...
        CKEDITOR.plugins.add("indent", {requires: "list", onLoad: function () {(CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat) && CKEDITOR.addCss(".cke_editable ul,.cke_editable ol{\tmargin-left: 0px;\tpadding-left: 40px;}")}, init: function (d) {
    ...
    (function () {
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({$: function (a) {
            ...
            var c = CKEDITOR.env, g = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (b) {
                ...
                focus: function () {CKEDITOR.document.getById(g).getChild(1).focus()}, execute: function (d) {
                    var b = f._;
            ...
            var k = CKEDITOR.tools.addFunction(function (a, b) {
                ...
                a.preventDefault()
            }), l = CKEDITOR.tools.addFunction(function () {d.onfocus && d.onfocus()}), i = 0, m = CKEDITOR.tools.addFunction(function () {
                if (CKEDITOR.env.opera) {
                    var b = a.editable();
        ...
        }, getValue: function () {return this._.value || ""}, unmarkAll: function () {this._.list.unmarkAll()}, mark: function (a) {this._.list.mark(a)}, hideItem: function (a) {this._.list.hideItem(a)}, hideGroup: function (a) {this._.list.hideGroup(a)}, showAll: function () {this._.list.showAll()}, add: function (a, b, c) {
            this._.items[a] = c || a;
    ...
    (function () {
        function n(a) {
            ...
            if (c.config.disableObjectResizing)try {this.getDocument().$.execCommand("enableObjectResizing", !1, !1)} catch (g) {this.attachListener(this, CKEDITOR.env.ie ? "resizestart" : "resize", function (a) {a.data.preventDefault()})}
            (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == c.document.$.compatMode) && this.attachListener(this, "keydown", function (a) {
                var b = a.data.getKeystroke();
                if (b == 33 || b == 34)if (CKEDITOR.env.ie)setTimeout(function () {c.getSelection().scrollIntoView()}, 0); else if (c.window.$.innerHeight > this.$.offsetHeight) {
                    var d = c.createRange();
    ...
    (function () {
        ...
        var i = CKEDITOR.htmlParser.cssStyle, h = CKEDITOR.tools.cssLength, j = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, l = {elements: {$: function (a) {
            ...
            return b
        }}}, k = CKEDITOR.plugins.add("fakeobjects", {afterInit: function (a) {(a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(l)}});
    ...
    CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function () {
        ...
        var a = "background:url(" + CKEDITOR.getUrl(this.path + "images/anchor.png") + ") no-repeat %1 center;border:1px dotted #00f;", d = ".%2 a.cke_anchor,.%2 a.cke_anchor_empty,.cke_editable.%2 a[name],.cke_editable.%2 a[data-cke-saved-name]{" + a + "padding-%1:18px;cursor:auto;}" + (CKEDITOR.env.ie ? "a.cke_anchor_empty{display:inline-block;}" : "") + ".%2 img.cke_anchor{" + a + "width:16px;min-height:15px;height:1.15em;vertical-align:" + (CKEDITOR.env.opera ? "middle" : "text-bottom") + ";}";
    ...
    (function () {
        ...
        function U(a) {
            ...
            B(a);
            var c = d.y > (a.inInlineMode ? e.editable.top + e.editable.height / 2 : Math.min(e.editable.height, e.pane.height) / 2), b = b[c ? "getLast" : "getFirst"](function (a) {return!(y(a) || z(a))});
            if (!b)return null;
        ...
        function M(a, b, d, e) {
            for (var f = function () {
                ...
                return n.ie ? function (a) {return d[CKEDITOR.tools.cssStyleToDomStyle(a)]} : function (a) {return d.getPropertyValue(a)}
        ...
        var Z = function () {
            ...
            function a(a) {
                ...
                if (f && e.contains(f))for (; !f.getParent().equals(e);)f = f.getParent(); else f = e.getFirst(function (c) {return b(a, c)});
                if (c && e.contains(c))for (; !c.getParent().equals(e);)c = c.getParent(); else c = e.getLast(function (c) {return b(a, c)});
                if (!f || !c)return null;
                m(a, f);
                m(a, c);
    ...
    (function () {
        ...
        var h = {editorFocus: !1, modes: {wysiwyg: 1,
            source: 1}}, g = {exec: function (c) {c.container.focusNext(!0, c.tabIndex)}}, f = {exec: function (c) {c.container.focusPrevious(!0, c.tabIndex)}};
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {init: function (a) {
            ...
            var b = new h(a), d = a.addCommand("undo", {exec: function () {b.undo() && (a.selectionChange(), this.fire("afterUndo"))}, state: CKEDITOR.TRISTATE_DISABLED, canUndo: !1}), e = a.addCommand("redo", {exec: function () {b.redo() && (a.selectionChange(), this.fire("afterRedo"))}, state: CKEDITOR.TRISTATE_DISABLED, canUndo: !1});
            a.setKeystroke([
        ...
        h.prototype = {type: function (a) {
            ...
            if (b)if (a)for (d = this.index - 1; 0 <= d; d--) {if (a = c[d], !b.equals(a, !0))return a.index = d, a} else for (d = this.index + 1; d < c.length; d++)if (a = c[d], !b.equals(a, !0))return a.index = d, a;
            return null
    ...
    CKEDITOR.config.plugins = 'basicstyles,dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,list,indent,enterkey,entities,listblock,richcombo,format,htmlwriter,horizontalrule,wysiwygarea,image,fakeobjects,link,magicline,maximize,pastetext,pastefromword,removeformat,sourcearea,specialchar,stylescombo,tab,table,tabletools,undo';
    CKEDITOR.config.skin = 'moonocolor';
    (function () {
        var icons = ( 'bold,0,italic,32,strike,64,subscript,96,superscript,128,underline,160,copy-rtl,192,copy,224,cut-rtl,256,cut,288,paste-rtl,320,paste,352,bulletedlist-rtl,384,bulletedlist,416,numberedlist-rtl,448,numberedlist,480,indent-rtl,512,indent,544,outdent-rtl,576,outdent,608,horizontalrule,640,image,672,anchor-rtl,704,anchor,736,link,768,unlink,800,maximize,832,pastetext-rtl,864,pastetext,896,pastefromword-rtl,928,pastefromword,960,removeformat,992,source-rtl,1024,source,1056,specialchar,1088,table,1120,redo-rtl,1152,redo,1184,undo-rtl,1216,undo,1248' ), path = CKEDITOR.getUrl('plugins/icons.png'), icons = icons.split(',');
