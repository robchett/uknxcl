    ...
    return{title: f.title, minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 370 : 350, minHeight: CKEDITOR.env.quirks ? 250 : 245, onShow: function () {
        ...
        {id: "general", label: c.lang.common.generalTab, elements: [
            ...
            {type: "html", id: "editing_area", style: "width:100%;height:100%", html: "", focus: function () {
                ...
                var a = this.getDialog().getParentEditor(), b = this.getInputElement().getFrameDocument().getBody(), d = b.getBogus(), c;
                d && d.remove();
                c = b.getHtml();
